...
<script src="${pageContext.request.contextPath}/resources/general.js"></script>
...
<link href="${pageContext.request.contextPath}/resources/css/jq.css" rel="stylesheet" type="text/css" media="all"/>
<link href="${pageContext.request.contextPath}/resources/css/general.css" rel="stylesheet" type="text/css" media="all"/>

<link href="${pageContext.request.contextPath}/resources/css/libs/bootstrap-v4.min.css" rel="stylesheet" type="text/css" media="all"/>
...
<link href="https://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js"></link>
<link href="http://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js"></link>
